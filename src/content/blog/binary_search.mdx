...
words: [
    "mid", "low", "high", "pivot", "sorted", "search_space", "target", "divide",
    "conquer", "iteration", "recursion", "logarithmic", "log2", "runtime",
    "complexity", "left_bound", "right_bound", "binary_tree", "monotonic",
    "condition", "predicate", "invariant", "while_loop", "midpoint", "index",
    "range", "bounds", "upper_bound", "lower_bound", "first_occurrence",
    "last_occurrence", "peak_element", "rotated_array", "infinite_array",
    "feasible", "check_function", "parametric_search", "decision_space",
    "pruning", "optimization", "search_interval", "convergence", "overflow",
    "two_pointers", "order", "ceil", "floor", "median", "partition"
]
